...
const PaginaAgregar = ({ navigation }) => {
    ...
    const uri = 'URI_CREADA';//Asegúrate de reemplazar la URL completa con la URI que has creado."
    const guardar = () => {
        ...
        fetch(`${uri}/productos`, {
            ...
            .then((responseJson) => {
                ...
                const mensaje = responseJson.message; // Asegúrate de que esto coincida con la respuesta del
                servidor
                if (!mensaje) {
